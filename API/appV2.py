...
def calculate_each_section(eachItem):
    ...
    for price in eachItem["spec"]:
        ...
        if not isFixed and isFaaS:
            ...
            iteration_cost_per_section = iteration_cost_per_section + price['iterationCost']
            ...
            if price['name'] in ["Development", "Training"]:
                ...
                fixed_cost_per_section = fixed_cost_per_section + price['fixedCost']
            else:
                ...
                monthly_cost_per_section = monthly_cost_per_section + (price['monthlyCost'])
                iteration_cost_per_section = iteration_cost_per_section + price['iterationCost']
...
def add():
    ...
    for eachItem in data:
        eachItem, iteration_cost, monthly_cost, fixed_cost = calculate_each_section(eachItem)
